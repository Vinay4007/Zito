...
class Level4Q : AppCompatActivity() {

    private var score:Int=0
    private var currentPosition:Int=1
    private var questionList:ArrayList<Questiondata4>?=null
    private var selected_option:Int=0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_level4_q)
            ...
            else
            {
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        var intent = Intent(this,Level4Result::class.java)
                        intent.putExtra(Setdata4.score,score.toString())
