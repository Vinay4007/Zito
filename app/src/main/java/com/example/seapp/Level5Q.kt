...
class Level5Q : AppCompatActivity() {

    private var score:Int=0
    private var currentPosition:Int=1
    private var questionList:ArrayList<Questiondata5>?=null
    private var selected_option:Int=0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_level5_q)
            ...
            else
            {
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        var intent = Intent(this,Level5Result::class.java)
                        intent.putExtra(Setdata5.score,score.toString())
