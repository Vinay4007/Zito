...
class Level2Q : AppCompatActivity() {

    private var score:Int=0
    private var currentPosition:Int=1
    private var questionList:ArrayList<Questiondata2>?=null
    private var selected_option:Int=0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_level2_q)
...
//            {
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        var intent = Intent(this,Level2Result::class.java)
                        intent.putExtra(Setdata2.score,score.toString())
