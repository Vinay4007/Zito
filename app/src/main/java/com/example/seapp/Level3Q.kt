...
class Level3Q : AppCompatActivity() {

    private var score:Int=0
    private var currentPosition:Int=1
    private var questionList:ArrayList<Questiondata3>?=null
    private var selected_option:Int=0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_level3_q)
...
//            {
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        var intent = Intent(this,Level3Result::class.java)
                        intent.putExtra(Setdata3.score,score.toString())
